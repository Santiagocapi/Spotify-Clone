...
- **Frontend - Interactivity:**
  ...
  - **Music Player**: Build the audio player component (`<audio>`).
  - **Create Playlist**: Frontend form for creating new playlists.
  - **Upload Song**: Frontend form for uploading MP3 files.
  - **Add to Playlist**: UI for adding songs to an existing playlist.
  - **Change all styles**: Thinking about using some library or other technology for the designs.
